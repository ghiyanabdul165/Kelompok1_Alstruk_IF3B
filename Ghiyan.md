...
a. Menampilkan menu
 ...
 print("1. Tambah") print("2. Kurang") print("3. Kali")
...
if pilihan == "1": hasil = tambah(angka1, angka2)
 ...
 operasi = "+" elif pilihan == "2": hasil =

 kurang(angka1, angka2) operasi = "-" elif pilihan == "3": hasil = kali(angka1, angka2) operasi = "×" elif pilihan == "4": hasil = bagi(angka1, angka2) operasi = "÷" 
